    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="pages">
          ...
          <?php endif; ?>
          <li><a href="<?php echo e(route('front.product', $productt->slug)); ?>"><?php echo e($name); ?></a>
          ...
          <div class="xzoom-container">
            ...
            <div class="col-lg-7">
              <div class="right-area">
                <div class="product-info">
                  <h4 class="product-name"><?php echo e($name); ?></h4>
            ...
            <div class="product-price">
              <p class="title"><?php echo e($langg->lang87); ?> :</p>
                    <p class="price"><span id="sizeprice"><?php echo e($price); ?></span>
                      <small><del><?php echo e($previous_price); ?></del></small></p>
