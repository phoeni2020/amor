...
<div class="content-area">
	...
	<form action="<?php echo e(route('admin-prod-store')); ?>" method="POST" enctype="multipart/form-data">
							...
							<div class="body-area">
								...
								<div class="gocover"
									...
									<div class="showbox">
										...
										@error('ship')
										    Estimated Shipping Time is required 
										@enderror
														...
														<div class="row">
															...
															<div class="col-md-4 col-sm-6">
																...
																<input type="number" name="size_qty[]" class="input-field"
																	placeholder="<?php echo e(__('Size Qty')); ?>" value="1" min="1" required>
															</div>
															<div class="col-md-4 col-sm-6">
																<label>
									...
									<div class="row" id="stckprod">
										...
										<div class="col-lg-12">
											<input name="stock" type="text" class="input-field"
												placeholder="<?php echo e(__('e.g 20')); ?>" required >
											<div class="checkbox-wrapper">
