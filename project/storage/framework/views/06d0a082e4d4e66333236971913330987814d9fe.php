...
<section style="background-image: url(<?php echo e(asset('assets/images/gif000.gif')); ?>);height:66px; width:auto;" class="adver"></section>
                                    ...
                                    <div>
                                        <ul>
                                            <?php $__currentLoopData = DB::table('languages')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(session()->get('language') == 1 && $language->id == 2 ): ?>
                                                    <li>    
                                                        <img style="border-radius:10px;width:20px; height:20px!important"src="<?php echo e(asset('assets/images/egypt-flag-icon-32.png')); ?>"  ></i>
                                                        <a   style="color:white" href="<?php echo e(route('front.language',$language->id)); ?>">
                                                        <?php echo e($language->language); ?>

                                                        </a>
                                                    </li>
                                                <?php elseif(session()->get('language') == 2 && $language->id == 1): ?>
                                                    <li>
                                                        <img style="border-radius:10px;width:20px; height:20px!important" src="<?php echo e(asset('assets/images/download.png')); ?>" ></i>
                                                    <li>
                                                       <a   style="color:white" href="<?php echo e(route('front.language',$language->id)); ?>">
                                                            <?php echo e($language->language); ?>
                                                ...
                                                <?php elseif(empty(session()->get('language')) && $language->is_default == 0 ): ?>
                                                    <li>    
                                                        <img style="border-radius:10px;width:20px; height:20px!important"src="<?php echo e(asset('assets/images/egypt-flag-icon-32.png')); ?>"  ></i>
                                                    <li><a  style="color:white" href="<?php echo e(route('front.language',$language->id)); ?>">
                                                        <?php echo e($language->language); ?>
                    ...
                    <div class="search-box">
                        <div class="categori-container" id="catSelectForm">
                            <select name="category" id="category_select" class="categoris">
                                ...
                                <option value="<?php echo e($data->slug); ?>" <?php echo e(Request::route('category') == $data->slug ? 'selected' : ''); ?>><?php if(isset($data->name_ar)){echo $data->name_ar; }else{echo $data->name;}?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<div style="position:relative;"id="myDIV">
					    <div style="z-index:10;position: absolute;" class="col-lg-3">  <div style="display:none!important" class="categories_menu_inner">
                        <ul>
                            <?php
                                $i=1;
                            ?>
                    ...
                    <div style="background: #ad1515;border:none!important;border-radius:0!important"class="search-box">
                        <div style="width:70%" class="categori-container" id="catSelectForm">
                            <select style="color:white!important" name="category" id="category_select" class="categoris">
                                <option style="color:black!important"value=""><?php echo e($langg->lang1); ?></option>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option style="color:black!important" value="<?php echo e($data->slug); ?>" <?php echo e(Request::route('category') == $data->slug ? 'selected' : ''); ?>><?php if(isset($data->name_ar)){echo $data->name_ar; }else{echo $data->name;}?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
        ...
        <div class="row">
                                        ...
                                        <ul>
                                            ...
                                            <?php $__currentLoopData = DB::table('languages')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($language->id == 1): ?>
                                                   <img style="border-radius:10px;width:20px; height:20px!important" src="<?php echo e(asset('assets/images/download.png')); ?>"  width="30px"></i>
                                                   <?php else: ?>
                                                    <img style="border-radius:10px;width:20px; height:20px!important" src="<?php echo e(asset('assets/images/egypt-flag-icon-32.png')); ?>" width="30px"></i>
                                                <?php endif; ?>
                                                  <a   style="color:white" href="<?php echo e(route('front.language',$language->id)); ?>">
                                                        <?php echo e($language->language); ?>
                ...
                <div class="footer-widget info-link-widget">
                    ...
                    <ul class="link-list">
                        ...
                        <li>
                         ...
                         <li class="gn">
                            <a href="">
                                <i class="gn fas fa-angle-double-right"></i>Help Center
                            </a>
                        </li>
                        <li class="gn">
                            <a href="">
                                <i class="gn fas fa-angle-double-right"></i>How to buy on Amor?
                            </a>
                        </li>
                        <li class="gn">
                            <a href="">
                                <i class="gn fas fa-angle-double-right"></i>How to pay on Amor?
                            </a>
                        </li>
                        <li class="gn">
                            <a href="">
                                <i class="gn fas fa-angle-double-right"></i>Delivery timelines
                            </a>
                        </li>
                        <li class="gn">
                            <a href="">
                                <i class="gn fas fa-angle-double-right"></i>Corporate Services
                            </a>
                        </li>
                         <li class="gn">
                            <a href="">
                                <i class="gn fas fa-angle-double-right"></i>Report a Product
                            </a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3 col-lg-3 gn">
                <div class="footer-widget info-link-widget">
                    <h4 class="title">
                        <?php echo e($langg->lang21); ?>
                    ...
                    <ul class="link-list">
                        <li>
                            <a href="<?php echo e(route('front.index')); ?>">
                                <i class="fas fa-angle-double-right"></i>Sell on Amor
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('front.index')); ?>">
                                <i class="fas fa-angle-double-right"></i>Amor Careers
                            </a>
                        </li>
                         <li>
                            <a href="<?php echo e(route('front.index')); ?>">
                                <i class="fas fa-angle-double-right"></i>Amor Express
                            </a>
                        </li>
                         <li>
                            <a href="<?php echo e(route('front.index')); ?>">
                                <i class="fas fa-angle-double-right"></i>Amor Mall
                            </a>
                        </li>
                         <li>
                            <a href="<?php echo e(route('front.index')); ?>">
                                <i class="fas fa-angle-double-right"></i>Stay Safe
                            </a>
                        </li>
                         <li>
                            <a href="<?php echo e(route('front.index')); ?>">
                                <i class="fas fa-angle-double-right"></i>Amor Logistics Services
                            </a>
                        </li>
                         <li>
                            <a href="<?php echo e(route('front.index')); ?>">
                                <i class="fas fa-angle-double-right"></i>Amor Global Festival
                            </a>
                        </li>
                         <li>
                            <a href="<?php echo e(route('front.index')); ?>">
                                <i class="fas fa-angle-double-right"></i>Black Friday 2020
                            </a>
                        </li>
            ...
            <div class="col-md-3 col-lg-3">
                <div>
                    ...
                    <ul class="link-list gn">
                        <li>
                            <a href="<?php echo e(route('front.index')); ?>">
                                <i class="fas fa-angle-double-right"></i>Become an Affiliate Partner
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('front.index')); ?>">
                                <i class="fas fa-angle-double-right"></i>Become a Logistics Service Partner
                            </a>
                        </li>
                         <li>
                            <a href="<?php echo e(route('front.index')); ?>">
                                <i class="fas fa-angle-double-right"></i>Become a Sales Consultant (J-Force )
                            </a>
                        </li>
                 ...
                 <li><img style="border-radius:10px; width:140px" src="<?php echo e(asset('assets/images/hero-playstore.png')); ?>  ">
                                           <img style="border-radius:10px; width:140px" src="<?php echo e(asset('assets/images/hero-appstore.png')); ?> "></li>
                                           <li style="padding-top:10px"> <img style="border-radius:10px;width:360px " src="<?php echo e(asset('assets/images/payments.png')); ?>"  ></li>
...
<div class="modal fade" id="comment-log-reg" tabindex="-1" role="dialog" aria-labelledby="comment-log-reg-Title"
    ...
    border-radius: 10px;font-weight:500;color:white;font-family:Roboto,-apple-system,BlinkMacSystemFont,"Segoe UI","Helvetica Neue",Arial,sans-serif 'type="submit" class="submit-btn"><?php echo e($langg->lang178); ?></button>
    ...
    font-size: 19px;" class="fab fa-facebook-f"></i>
                             <p style='display:inline-block;font-size: .975rem;font-weight:500;color:white;font-family:Roboto,-apple-system,BlinkMacSystemFont,"Segoe UI","Helvetica Neue",Arial,sans-serif 'class="text"><?php echo e($langg->lang180); ?></p>
