                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-7">
                                        <div class="img-upload">
                                            ...
                                            <br><br><br>
                                            <div id="image-preview" class="img-preview" style="background: url({{ $data->best_seller_banner_ar ? asset('assets/images/'.$data->best_seller_banner_ar):asset('assets/images/noimage.png') }});">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-7">
                                        <div class="img-upload">
                                            ...
                                            <br><br><br>
                                            <div id="image-preview" class="img-preview" style="background: url({{ $data->best_seller_banner1_ar ? asset('assets/images/'.$data->best_seller_banner1_ar):asset('assets/images/noimage.png') }});">
                                                <label for="image-upload" class="img-label" id="image-label"><i class="icofont-upload-alt"></i>الصورة بالعربي</label>
