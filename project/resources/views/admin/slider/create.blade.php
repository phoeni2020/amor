                      ...
                      @include('includes.admin.form-both') 
                                              ...
                                              <div class="form-group">
                                                  <div class="col-sm-12">
                                                    <label class="control-label" for="subtitle_text">{{ __('Text') }}*</label>
                                                      ...
                                                      <label class="control-label" for="subtitle_text">العنوان الفرعي بالعربي*</label>

                                                      <textarea class="form-control" name="subtitle_text_ar" id="subtitle_text" rows="5"  placeholder="{{ __('Enter Title Text') }}"></textarea>
                                                  </div>
                                              </div>
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" name="title_text" id="title_text" rows="5"  placeholder="{{ __('Enter Title Text') }}"></textarea>
                                                      ...
                                                      <label class="control-label" for="title_text">العنوان بالعربي</label>

                                                      <textarea class="form-control" name="title_text_ar" id="title_text" rows="5"  placeholder="{{ __('Enter Title Text') }}"></textarea>
                                                  </div>
                                              </div>
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <label class="control-label" for="details_text">النص بالعربي</label>

                                                  <textarea class="form-control" name="details_text_ar" id="details_text" rows="5"  placeholder="{{ __('Enter Title Text') }}"></textarea>
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <div class="img-upload full-width-img">
                                      <div id="image-preview" class="img-preview" style="background: url({{ asset('assets/admin/images/upload.png') }});">
                                          <label for="image-upload" class="img-label" id="image-label"><i class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                          <input type="file" name="photo_ar" class="img-upload" id="image-upload">
                                      </div>
                                      <p class="text">{{ __('Prefered Size: (1920x800) or Square Sized Image') }}</p>
                                  </div>
