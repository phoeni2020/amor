...
@php
            ...
            $price = $productt->showPrice($product->price);
            $name = $productt->showName($product->name);
            ...
            $previous_price = $productt->showPreviousPrice($product->previous_price);
          @endphp
  </div>
<div class="col-lg-7">
<div class="right-area">
  <div class="product-info">
      ...
      <div class="product-price">
          ...
          <p class="price"><span id="msizeprice">{{$price}}</span>
