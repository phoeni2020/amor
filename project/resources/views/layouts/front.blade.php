                                        ...
                                        <ul>
                                            @foreach(DB::table('languages')->get() as $language)
                                                @if(session()->get('language') == 1 && $language->id == 2 )
                                                    <li>    
                                                        <img style="border-radius:10px;width:20px; height:20px!important"src="{{asset('assets/images/egypt-flag-icon-32.png')}}"  ></i>
                                                ...
                                                @elseif(session()->get('language') == 2 && $language->id == 1)
                                                    <li>
                                                        <img style="border-radius:10px;width:20px; height:20px!important" src="{{asset('assets/images/download.png')}}" ></i>
                                                    <li>
                                                       <a   style="color:white" href="{{route('front.language',$language->id)}}">
                                                            {{$language->language}}
                                                     </a>
                                                    </li>
                                                @elseif(empty(session()->get('language')) && $language->is_default == 0 )
                                                    <li>    
                                                        <img style="border-radius:10px;width:20px; height:20px!important"src="{{asset('assets/images/egypt-flag-icon-32.png')}}"  ></i>
                                                    <li><a  style="color:white" href="{{route('front.language',$language->id)}}">
                                                        {{$language->language}}
                                                        </a></li>
                                                    @break
                                                @endif
...
--}} 
            ...
            <div class="col-md-3 col-lg-3">
                <div>
                 ...
                 <li><img style="border-radius:10px; width:140px" src="{{asset('assets/images/hero-playstore.png')}}  ">
                                           <img style="border-radius:10px; width:140px" src="{{asset('assets/images/hero-appstore.png')}} "></li>
                                           <li style="padding-top:10px"> <img style="border-radius:10px;width:360px " src="{{asset('assets/images/payments.png')}}"  ></li>
