...
class CategoryController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $data_ar = Category_ar::find($id);
        
        return view('admin.category.edit',compact('data','data_ar'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($data_ar == null){
            ...
            $cat_ar = new Category_ar();
            $data = ['name_ar'=>$request->name_ar ,'id'=>$id];
            $cat_ar->create($data);
            $cat_ar->save();
        }
        
        if($request->name_ar && $data_ar != null){
