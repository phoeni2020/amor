...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
	...
	public function index(Request $request)
	{
	  ...
	  // https://api.currconv.com/api/v7/convert?q=USD_IQD,IQD_USD&compact=ultra&apiKey=8ab4d1295a6d4bf6892a3d4768cb629b&callback=sampleCallback
       $new_val = file_get_contents('https://api.currconv.com/api/v7/convert?q=USD_EGP,EGP_USD&compact=ultra&apiKey=8ab4d1295a6d4bf6892a3d4768cb629b');
	   $value = json_decode($new_val, true);
       $curncy = $value['USD_EGP'];
       $curncy = Currency::where('code','=','4217')->update(['value'=>$curncy]);
        $this->code_image();
        ...
        $sliders = DB::table('sliders')->get();
         ...
         if($lang == 2){
                $top_small_banners =
                    DB::table('banners')->select('photo_ar','link')->where('type','=','TopSmall')->get();
            }
         else{
        ...
        if($lang== 1 ||$lang == null){
        $feature_products =  Product::where('featured','=',1)->where('status','=',1)->select($selectable)->orderBy('id','desc')->take(10)->get();
        ...
        $feature_products = DB::table('products')
                                ...
                                ->where('products.featured','=',1)->where('status','=',1)
    ...
    public function extraIndex()
    {
        ...
        if($lang== 1||$lang == null){
            ...
            $discount_products = DB::table('products')
                ->join('product_ars','product_ars.id','=','products.id')
                ->select('products.*', 'product_ars.name_ar', 'product_ars.details_ar')
                ->where('products.is_discount','=',1)->where('status','=',1)
        ...
        if($lang == 1 ||$lang == null ){
            ...
            $best_products = DB::table('products')
                ->join('product_ars','product_ars.id','=','products.id')
                ->select('products.*', 'product_ars.name_ar', 'product_ars.details_ar')
                ->where('products.best','=',1)->where('status','=',1)->orderBy('id','desc')->take(6)
                ->get();
        ...
        if($lang== 1 || $lang == null ){
            ...
            $top_products = DB::table('products')
                ->join('product_ars','product_ars.id','=','products.id')
                ->select('products.*', 'product_ars.name_ar', 'product_ars.details_ar')
                ->where('products.top','=',1)->where('status','=',1)->
        ...
        if($lang== 1 || $lang == null ){
            ...
            $trending_products = DB::table('products')
                ->join('product_ars','product_ars.id','=','products.id')
                ->select('products.*', 'product_ars.name_ar', 'product_ars.details_ar')
                ->where('products.trending','=',1)->where('status','=',1)
        ...
        if($lang== 1 || $lang == null ){
            ...
            $hot_products = DB::table('products')
                ->join('product_ars','product_ars.id','=','products.id')
                ->select('products.*', 'product_ars.name_ar', 'product_ars.details_ar')
                ->where('products.hot','=',1)->where('status','=',1)->
                orderBy('id','desc')->take(9)
                ->get();
        }
        ...
        if($lang== 1 || $lang == null ){
            ...
            $latest_products = DB::table('products')
                ->join('product_ars','product_ars.id','=','products.id')
                ->select('products.*', 'product_ars.name_ar', 'product_ars.details_ar')
                ->where('products.latest','=',1)->where('status','=',1)
                ->orderBy('id','desc')->take(9)
                ->get();
        }
        if($lang== 1 || $lang == null ){
        ...
        if($lang== 1 || $lang == null ){
            ...
            $sale_products = DB::table('products')
                ->join('product_ars','product_ars.id','=','products.id')
                ->select('products.*', 'product_ars.name_ar', 'product_ars.details_ar')
                ->where('products.sale', '=', 1)->where('products.status', '=', 1)
                ->orderBy('id','desc')->take(9)
                ->get();
        }
